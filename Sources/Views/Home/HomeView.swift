...
struct HomeView: View {
    ...
    private func showDetail(for index: Int, isDynamic: Bool) {
        let mock = createMockWallpaper(index: index, isDynamic: isDynamic)
        detailWallpaper = mock
    }

    private func navigateDetail(direction: Int) {
    ...
    private func createMockWallpaper(index: Int, isDynamic: Bool) -> Wallpaper {
