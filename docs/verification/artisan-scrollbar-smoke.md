...
4. Confirm a thin custom scrollbar appears near the right edge.
5. Move the pointer over the page and confirm the scrollbar subtly widens and brightens.
6. Scroll the page and confirm the thumb tracks the scroll position.
